                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3 p-3 mb-2 rounded"
                            ...
                            <button type="button"
                                    ...
                                    data-link-base="{{ route('admin.customers.files.link', [$customer, '__FILE__']) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3 p-3 mb-2 rounded"
                            ...
                            <button type="button"
                                    ...
                                    data-link-base="{{ route('admin.customers.order-files.link', [$customer, '__FILE__']) }}">
                                <i class="ri-links-line me-1"></i>Link
                            </button>
                            <a href="{{ Storage::url($file->file_path) }}" target="_blank"
                               class="btn btn-sm btn-outline-primary flex-shrink-0">
...
{{-- Hidden form for link submissions --}}
