...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Dashboard') | GMS Admin</title>
    ...
    <!-- Font Awesome v5 (for icon picker) -->
    ...
    <style>
        ...
        .navbar-brand-box .logo-text span {
            color: #5664d2;
        }
        #sidebar-menu {
            padding: 10px 0 30px;
...
<body>
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="#"><i class="mdi mdi-account-outline me-2"></i>Profile</a>
    ...
    <footer class="footer">
        <div class="row">
            ...
            <div class="col-sm-6 text-end">GMS Admin Portal</div>
        </div>
    </footer>
    ...
    {{-- ZIWO Softphone (only for admin/staff with a linked call agent) --}}
