            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" placeholder="e.g. VAT Registration" value="{{ old('name') }}" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select @error('service_type') is-invalid @enderror" name="service_type" id="service_type" required>
                                <option value="both" {{ old('service_type', 'both') === 'both' ? 'selected' : '' }}>Book Now &amp; Enquire Now</option>
                                <option value="book_now" {{ old('service_type') === 'book_now' ? 'selected' : '' }}>Book Now Only</option>
                                <option value="enquire_now" {{ old('service_type') === 'enquire_now' ? 'selected' : '' }}>Enquire Now Only</option>
                            </select>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group" style="max-width:320px;">
                                <input type="number" class="form-control @error('estimate_value') is-invalid @enderror"
                                    ...
                                    placeholder="e.g. 3" min="1" value="{{ old('estimate_value') }}">
                                <select class="form-select @error('estimate_unit') is-invalid @enderror"
                                    ...
                                    <option value="hours" {{ old('estimate_unit') === 'hours' ? 'selected' : '' }}>Hours</option>
                                    <option value="days"  {{ old('estimate_unit', 'days') === 'days'  ? 'selected' : '' }}>Days</option>
                                    <option value="weeks" {{ old('estimate_unit') === 'weeks' ? 'selected' : '' }}>Weeks</option>
                                </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            @php $limitReached = $trendingCount >= 5; @endphp
                    ...
                    <div id="package_pricing_section" style="{{ old('has_packages') ? '' : 'display:none;' }}">
                            ...
                            <div class="col-sm-10 d-flex align-items-center">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" name="has_premium_package" id="has_premium_package" value="1"
                                        {{ old('has_premium_package') ? 'checked' : '' }}>
                        ...
                        <div class="card bg-light border mb-3">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="basic_package_description" id="basic_package_description" style="display:none;">{!! old('basic_package_description') !!}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control @error('basic_package_actual_price') is-invalid @enderror"
                                                    ...
                                                    placeholder="0.00" step="0.01" min="0"
                                                    value="{{ old('basic_package_actual_price') }}">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="d-flex gap-2 align-items-start">
                                                <select class="form-select @error('basic_package_discount_type') is-invalid @enderror"
                                                    ...
                                                    <option value="percentage" {{ old('basic_package_discount_type', 'percentage') === 'percentage' ? 'selected' : '' }}>Percentage (%)</option>
                                                    <option value="flat" {{ old('basic_package_discount_type') === 'flat' ? 'selected' : '' }}>Flat Amount (AED)</option>
                                                </select>
                                                <div class="input-group" style="max-width:160px;">
                                                    <input type="number" class="form-control @error('basic_package_discount_value') is-invalid @enderror"
                                                        ...
                                                        value="{{ old('basic_package_discount_value') }}">
                                                    <span class="input-group-text" id="basic_discount_unit">%</span>
                                                </div>
                                            </div>
                        ...
                        {{-- Premium Package --}}
                        <div id="premium_package_section" class="card border-warning mb-3" style="{{ old('has_premium_package') ? '' : 'display:none;' }}">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">What's Included</label>
                                    <div class="col-sm-10">
                                        <textarea name="premium_package_description" id="premium_package_description" style="display:none;">{!! old('premium_package_description') !!}</textarea>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('premium_package_price') is-invalid @enderror"
                                                ...
                                                placeholder="0.00" step="0.01" min="0"
                                                value="{{ old('premium_package_price') }}">
                                ...
                                <div id="premium_offer_section" style="{{ old('premium_has_offer') ? '' : 'display:none;' }}">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control @error('premium_package_actual_price') is-invalid @enderror"
                                                    ...
                                                    placeholder="0.00" step="0.01" min="0"
                                                    value="{{ old('premium_package_actual_price') }}">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="d-flex gap-2 align-items-start">
                                                <select class="form-select @error('premium_package_discount_type') is-invalid @enderror"
                                                    ...
                                                    <option value="percentage" {{ old('premium_package_discount_type', 'percentage') === 'percentage' ? 'selected' : '' }}>Percentage (%)</option>
                                                    <option value="flat" {{ old('premium_package_discount_type') === 'flat' ? 'selected' : '' }}>Flat Amount (AED)</option>
                                                </select>
                                                <div class="input-group" style="max-width:160px;">
                                                    <input type="number" class="form-control @error('premium_package_discount_value') is-invalid @enderror"
                                                        ...
                                                        placeholder="0" step="0.01" min="0"
                                                        value="{{ old('premium_package_discount_value') }}">
                                                    <span class="input-group-text" id="premium_discount_unit">%</span>
                                                </div>
                                            </div>
...
<script>
    ...
    // If page loaded with sections already visible (old() after validation failure)
