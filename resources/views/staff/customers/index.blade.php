    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                {{-- Filters --}}
                <form method="GET" action="{{ route('staff.customers.index') }}" class="row g-2 align-items-end mb-4">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-auto d-flex gap-2">
                        ...
                        @if(request()->hasAny(['search','country','status']))
                            <a href="{{ route('staff.customers.index') }}" class="btn btn-sm btn-outline-secondary">
