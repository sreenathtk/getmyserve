...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Dashboard') | GMS Provider</title>
    ...
    <style>
        ...
        .navbar-brand-box .logo-text span { color: #34d399; }
        .navbar-brand-box .role-tag {
            color: #6ee7b7; font-size: 11px; text-transform: uppercase;
        ...
        #sidebar-menu .menu-title {
            ...
            text-transform: uppercase; color: #6ee7b7; font-weight: 600; opacity: .7;
        }
        #sidebar-menu ul { list-style: none; padding: 0; margin: 0; }
        #sidebar-menu ul li a {
            display: flex; align-items: center; padding: 10px 20px;
            color: #a7f3d0; font-size: 14px; text-decoration: none; transition: all 0.2s;
        }
        ...
        #sidebar-menu ul li a.active { border-left: 3px solid #34d399; }
        .page-topbar {
        ...
        .badge-soft-primary { background: rgba(5,150,105,.18); color: #059669; }
...
<body>
    <div class="vertical-menu">
        <div class="navbar-brand-box">
            <div>
                ...
                <span class="role-tag">Provider Portal</span>
            </div>
        </div>
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown">
                <button class="btn btn-light btn-sm dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <span class="badge badge-soft-primary ms-1" style="font-size:10px;">Provider</span>
                </button>
    ...
    <footer class="footer">
        <div class="row">
            ...
            <div class="col-sm-6 text-end">GMS Provider Portal</div>
        </div>
    </footer>
